                ...
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                  <div className="box_form clearfix">
                    ...
                    <div className="box_login last">
                      ...
                      <button
                        type="submit"
                        class="w-full py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-black hover:bg-gray-100 hover:text-gray-500 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                      >
                        {lang["Giriş yap"]}
                      </button>
                    </div>
